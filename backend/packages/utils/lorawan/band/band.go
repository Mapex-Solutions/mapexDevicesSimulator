...
var regions = map[string]Region{
	"EU868": {Name: "EU868", UplinkFrequency: 868_100_000, UplinkSF: 7, RX2Frequency: 869_525_000, RX2SF: 12, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"US915": {Name: "US915", UplinkFrequency: 902_300_000, UplinkSF: 7, RX2Frequency: 923_300_000, RX2SF: 12, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"AU915": {Name: "AU915", UplinkFrequency: 915_200_000, UplinkSF: 7, RX2Frequency: 923_300_000, RX2SF: 12, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"AS923": {Name: "AS923", UplinkFrequency: 923_200_000, UplinkSF: 7, RX2Frequency: 923_200_000, RX2SF: 10, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"CN470": {Name: "CN470", UplinkFrequency: 470_300_000, UplinkSF: 7, RX2Frequency: 505_300_000, RX2SF: 12, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"IN865": {Name: "IN865", UplinkFrequency: 865_062_500, UplinkSF: 7, RX2Frequency: 866_550_000, RX2SF: 10, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"KR920": {Name: "KR920", UplinkFrequency: 922_100_000, UplinkSF: 7, RX2Frequency: 921_900_000, RX2SF: 12, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
	"RU864": {Name: "RU864", UplinkFrequency: 868_900_000, UplinkSF: 7, RX2Frequency: 869_100_000, RX2SF: 12, RX1Delay: time.Second, JoinAcceptDelay1: 5 * time.Second},
}
