...
// errMalformedCipherText uses the local error shim (see errors.go); the cipher-text
// length check is the only consumer and calls .New().
var errMalformedCipherText = &errDef{msg: "malformed cipher text"}
